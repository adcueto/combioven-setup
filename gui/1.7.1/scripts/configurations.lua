...
function GetCleanRecommends(usedTimeCamera, usedTimeBoiler)
  local data = {}
  ...
  logger.info("Wash Recommends : "..data["Layer_DialogBoxSuggest.text_InputField.text"])
  gre.set_data(data)
end 
...
function CBGetCleanStatus()
  ...
  gre.set_value("Layer_DialogBoxSuggest.text_Message.text", "Ciclo de lavado recomendado")
